...
void Config::setErrorPagesMap	(std::map<std::string,std::string> error_pages)			{ this->_error_pages = error_pages; }
void Config::setErrorNamesMap	(std::map<std::string,std::string> error_names)			{ this->_error_names = error_names; }
...
std::map<std::string,std::string>					&Config::getErrorPagesMap(void)			{ return(_error_pages); }
std::map<std::string,std::string>					&Config::getErrorNamesMap(void)			{ return(_error_names); }
...
std::string
Config::getErrorPages(const std::string& format) {
	std::map<std::string, std::string>::iterator itm;
	itm = _error_pages.find(format);
	if (itm != _error_pages.end()){
		return (itm->second);
	}
	else
	{
		std::cerr<<R<< "Error: getErrorPages: "<< format << " not found." <<RE<< std::endl;
		return (std::string());
	}
}
...
std::string
Config::getErrorNames(const std::string& format) {
	std::map<std::string, std::string>::iterator itm;
	itm = _error_names.find(format);
	if (itm != _error_names.end()){
		return (itm->second);
	}
	else
	{
		std::cerr<<R<< "Error: getErrorNames: "<< format << " not found." <<RE<< std::endl;
		return (std::string());
	}
}
